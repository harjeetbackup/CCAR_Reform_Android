...
////        else if (eventType.contains("parashat")) {
              ...
              else if (eventName.equals("Parashat B'shalach")) {
              ...
              else if (eventName.equals("Ki Tavo") || eventName.contains("Tavo")) {
              ...
              else if (eventName.equals("Parashat B'chukotai")) {
                  url = htmlFileUrl + "OlderHtmlFile/B'chukotai.html";
              }
              ...
              else if (eventName.equals("Parashat Nitzavim/Vayeilech")) {
...
//              }
              ...
              else if (eventName.equals("Parashat Vayeira")) {
                  url = htmlFileUrl + "OlderHtmlFile/Vayeira.html";
              }
              ...
              else if (eventName.equals("Erev Rosh Hashanah Weekday")){
              ...
              else if (eventName.equals("Pesach Chol HaMoed Day 5 Weekday") && !(days==6)) {
              ...
              else if (eventName.equals("Parashat Chukat/Balak")) {
                  url = htmlFileUrl + "OlderHtmlFile/Chukat-Balak.html";
              }
              else if (eventName.equals("Erev Pesach/Ta’anit Bechorot") && !(days==6)) {
                  url = htmlFileUrl + "OlderHtmlFile/Erev_Pesach-Ta'anit_Bechorot.html";
              }
              else if (eventName.equals("Erev Pesach/Ta’anit Bechorot Friday") && (days==6)) {
              ...
              else if (eventName.equals("Tu B'Sh'vat") ) {
                  url = htmlFileUrl + "OlderHtmlFile/Tu_B'Sh'vat.html";
              }
              else if (eventName.equals("Tu B'Av") ) {
                  url = htmlFileUrl + "OlderHtmlFile/Tu_B'Av.html";
              }
              else if (eventName.equals("Tzom Tammuz") ) {
                  url = htmlFileUrl + "OlderHtmlFile/Shiva_Asar_b'Tammuz.html";
              }
              else if (eventName.equals("Shiva Asar b'Tammuz") ) {
                  url = htmlFileUrl + "OlderHtmlFile/Shiva_Asar_b'Tammuz.html";
              }
              else if (eventName.equals("Erev Tisha b'Av") ) {
                  url = htmlFileUrl + "OlderHtmlFile/Erev_Tisha_b'Av.html";
              }
              else if (eventName.equals("Tisha B'Av") ) {
                  url = htmlFileUrl + "OlderHtmlFile/Tisha_B'Av.html";
              }
              else if (eventName.equals("Yom HaShoah V'hag'vurah")) {
                  url = htmlFileUrl + "OlderHtmlFile/Yom_HaShoah_V'hag'vurah.html";
              }
              else if (eventName.equals("Yom Ha'atzma'ut") ) {
                  url = htmlFileUrl + "OlderHtmlFile/Yom_Ha'atzma'ut.html";
              }
              else if (eventName.equals("Shmini Atzeret")) {
              ...
              else if (eventName.equals("Lag Ba'Omer")) {
                  url = htmlFileUrl + "OlderHtmlFile/Lag_Ba'Omer.html";
              }
              else if (eventName.equals("Sukkot I")) {
              ...
              else if (eventName.equals("Sukkot 2 Weekday") && (days==7)) {
                  url = htmlFileUrl + "Chol_Hamoed_Sukkot_Shabbat.html";
              }
              else if (eventName.equals("Sukkot 3 Weekday") && !(days==7)) {
              ...
              else if (eventName.equals("Sukkot 4 Weekday") && !(days==7)) {
              ...
              else if (eventName.equals("Shabbat_Shuva")) {
                  url = htmlFileUrl + "OlderHtmlFile/Shabbat_Ha'azinu-Shabbat_Shuva.html";
              }

              else if (eventName.equals("Chanukah: 6th Night") && !(days==7)) {
                  url = htmlFileUrl + "OlderHtmlFile/Chanukah_6th_Night.html";
              }else if (eventName.equals("Chanukah: 6th Night") && (days==7)) {
                  url = htmlFileUrl + "OlderHtmlFile/Shabbat_Chanukah.html";
              }

              else if (eventName.equals("Chanukah: 8th Night") && !(days==7)) {
                  url = htmlFileUrl + "OlderHtmlFile/Chanukah_8th_Night.html";
                  }
                  else if (eventName.equals("Chanukah: 8th Night") && (days==7)) {
                  url = htmlFileUrl + "OlderHtmlFile/Shabbat_Chanukah.html";
                  }
              else if (eventName.equals("Ta'anit Bechorot") ) {
        ...
        else if (eventName.equals("33rd day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Lag_Ba'Omer.html";
        }

        else if (eventName.equals("16th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("17th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("18th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("19th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("20th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("21st day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("22nd day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("23rd day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("24th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("25th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("26th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("27th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("28th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("29th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("30th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("31st day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("32nd day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("34th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("35th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("36th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("37th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("38th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("39th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("40th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("41st day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("42nd day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("43rd day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("44th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("45th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("46th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("47th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.contains("48th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("49th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("33rd day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("14th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("1st day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("2nd day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("3rd day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("4th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("5th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("6th day of the Omer") ) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("7th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("8th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("9th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("10th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("11th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("12th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }
        else if (eventName.equals("13th day of the Omer")) {
            url = htmlFileUrl + "OlderHtmlFile/Counting_the_Omer.html";
        }


              else if (eventName.equals("Rosh Chodesh Tamuz")){
                  ...
                  url = htmlFileUrl + "OlderHtmlFile/Erev_Rosh_Chodesh_Weekday.html";
              }else if (eventName.equals("Erev Rosh Chodesh Friday") && (days==6)) {
                  url = htmlFileUrl + "OlderHtmlFile/Erev_Rosh_Chodesh_Friday.html";
              }


              else if (eventName.equals("Parashat Tzav")) {
                  url = htmlFileUrl + "OlderHtmlFile/Tzav.html";
                   ...
                   url = htmlFileUrl + "OlderHtmlFile/Sh'mini_II.html";
                    ...
                    else if (eventName.equals("Erev Pesach") && !(days==6)) {
                        url = htmlFileUrl + "OlderHtmlFile/Erev_Pesach-Ta'anit_Bechorot.html";
                    }
                    ...
                    else if (eventName.equals("Shabbat Chazon")) {
                        url = htmlFileUrl + "OlderHtmlFile/Shabbat_D'varim-Shabbat_Chazon.html";
                    }
                 else if (eventName.equals("Shabbat Shuva")) {
                  url = htmlFileUrl + "OlderHtmlFile/Shabbat_Shuva.html";
                    ...
                    else if (eventName.equals("Purim Katan")) {
...
//
                    ...
                    else if ((eventName.contains("Shabbat Acharei Mot-K'doshim"))) {
                        url = htmlFileUrl + "OlderHtmlFile/Shabbat_Acharei_Mot-K'doshim.html";
                    }
                    else if ((eventName.contains("Shabbat Acharei_Mot")) && !(days==6)) {
                        url = htmlFileUrl + "OlderHtmlFile/Shabbat_Acharei_Mot.html";
                    }
                    else if ((eventName.contains("Shabbat B'chukotai"))  && !(days==6)) {
...
//
                    ...
                    else if (eventName.equals("Shabbat HaGadol") ) {
                    ...
                    else if ((eventName.contains("Shabbat Mas'ei")) ) {
                    ...
                    else if ((eventName.contains("Shabbat N'tzavim Vayeilech"))  ) {
                        url = htmlFileUrl + "OlderHtmlFile/Shabbat_N'tzavim_Vayeilech.html";
                    }
                    else if ((eventName.contains("Shabbat N'tzavim")) ) {
                        url = htmlFileUrl + "OlderHtmlFile/Shabbat_N'tzavim.html";
                    }
                    else if ((eventName.contains("Shabbat Naso"))  ) {
                        url = htmlFileUrl + "OlderHtmlFile/Shabbat_Naso.html";
                    }
                    else if ((eventName.contains("Shabbat Noach")) ) {
                   ...
                   url = htmlFileUrl + "OlderHtmlFile/Purim.html";
                    ...
                    else if (eventName.equals("Shabbat Zachor") ) {
            ...
            else if (eventName.equals("Erev Shavuot") && (days==6)) {
                url = htmlFileUrl + "OlderHtmlFile/Erev_Shavuot_Friday.html";
            }
            else if (eventName.equals("Yom Kippur") && (days==6)) {
                url = htmlFileUrl + "OlderHtmlFile/Erev_Yom_Kippur_Friday.html";
            }
            else if (eventName.equals("Erev Sukkot") && (days==6)) {
                url = htmlFileUrl + "OlderHtmlFile/Erev_Sukkot_Friday.html";
            }
                 else if (eventName.equals("Pesach Day 7 Shabbat") && (days==7)) {
                      url = htmlFileUrl + "OlderHtmlFile/Pesach_Day_7_Shabbat.html";
                    }
                    else if (eventName.equals("Pesach Day VII") && !(days==7)) {
                        url = htmlFileUrl + "OlderHtmlFile/Pesach_Day_7.html";
                    }

                    else if (eventName.equals("Pesach I") && (days==7)) {
                        url = htmlFileUrl + "OlderHtmlFile/Pesach_Day_1_Shabbat.html";
                    }
                    else if (eventName.equals("Pesach I") && !(days==7)) {
                        url = htmlFileUrl + "OlderHtmlFile/Pesach_Day_1_Weekday.html";
                    }
                    else if (eventName.equals("Pesach VIII") ) {
