...
public class ParshiyotEventRecyclerAdapter extends RecyclerView.Adapter<ParshiyotEventRecyclerAdapter.ViewHolder>{
    ...
    public ParshiyotEventRecyclerAdapter(Context context, ArrayList<ParseIsraelItemBean> data) {
    ...
    @Override
    public ParshiyotEventRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_events_rosh, parent, false);
        return new ParshiyotEventRecyclerAdapter.ViewHolder(view);
    }
    ...
    @Override
    public void onBindViewHolder(final ParshiyotEventRecyclerAdapter.ViewHolder holder, final int position) {
